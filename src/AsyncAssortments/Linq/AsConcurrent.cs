...
public static partial class AsyncEnumerable {
    ...
    public static IScheduledAsyncEnumerable<TSource> AsConcurrent<TSource>(this IAsyncEnumerable<TSource> source, bool preserveOrder = true, int maxConcurrency = -1) {
        if (source == null) {
